...
public class UIPickableFormRenderer extends UIFormRenderer
{
    ...
    {
        /* Gizmo picking removed - only available during keyframe bone selection and editing */
    ...
    private void renderAxes(UIContext context)
    {
        ...
        /* Gizmo rendering removed - only show during keyframe bone selection and editing */
